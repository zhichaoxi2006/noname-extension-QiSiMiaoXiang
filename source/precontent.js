...
export async function precontent(config, pack) {
    ...
    if (lib.namePrefix) {
        ...
        const prefix = {
            'qsmx': ['qsmx_huatuo', 'qsmx_menghuo', 'qsmx_caorui', 'qsmx_baozheng', 'qsmx_sunce', 'qsmx_jiaxu', 'qsmx_luxun', 'qsmx_xusha', 'qsmx_zhonghui', 'qsmx_sunquan', 'qsmx_wangshuang', 'qsmx_nanhua', 'qsmx_cenhun', 'qsmx_huangzhong', 'qsmx_zhenji', 'qsmx_guanyu', 'qsmx_caocao', "qsmx_caopi"],
